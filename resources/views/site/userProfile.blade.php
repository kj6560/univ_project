                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <select class="form-control" name="gender" required>
                                        ...
                                        <option value="1" {{!empty($userPersonalDetails->gender)==1?'selected':''}}>Male</option>
                                        <option value="2" {{!empty($userPersonalDetails->gender)==2?'selected':''}}>Female</option>
                                        <option value="3" {{!empty($userPersonalDetails->gender)==3?'selected':''}}>Other</option>
                                    </select>
                                </div>
                            </div>
                            <hr>
