...
class MiscController extends Controller
{
    ...
    public function getUserPerformance(Request $request)
    {
        ...
        if (!empty($request->user_id)) {
            ...
            ->select(['events.id as event_id','event_result.event_id','event_result.event_result_key','event_result.event_result_value','events.event_name','events.event_date','events.event_location'])
